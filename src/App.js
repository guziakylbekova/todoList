...
const url = 'https://6565b927eb8bb4b70ef23a3f.mockapi.io/todo'
                        ...
                        todos.map(todo =>
                            <div className={'todo-wrapper'} key={todo.id}>
                                {editTodo === todo.id ? (
                                    ...
                                    <>
                                        <input className={'editInput'} placeholder={"Edit Todo"} type="text"
                                               value={editTodoTitle}
                                    ...
                                    <>
                                        ...
                                        <div className="btn-container">
                                            ...
                                            <button className={'deleteBtn'} onClick={() => handleDeleteTodo(todo)}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                     viewBox="0 0 24 24">
                                                    <path
